...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={`inline-flex h-12 items-center justify-center rounded-lg bg-slate-100 p-1 text-slate-500 ${className || ''}`}
    {...props}
  />
))
